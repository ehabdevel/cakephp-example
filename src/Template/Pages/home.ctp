            ...
            <div class="columns large-12">
                ...
                <div class="mijmenu">
                    <ul>
                        ...
                        <li class="challenge">Static page</li>
                        <li class="challenge"><a href="http://localhost:8765/users">Users page</a></li>
                        <li class="challenge"><a href="http://localhost:8765/users/login">Login page</a></li>
                        <li class="challenge">Register page</li>
                    </ul>
                </div>
