...
if (!Configure::read('debug')):
    throw new NotFoundException('Please replace src/Template/Pages/huis.ctp with your own version.');
endif;
*/
    ...
    <body class="home">
        ...
        <div class="row">
            <div class="columns large-12">
                <div class="ctp-warning alert text-center" style="display: none;">
                    <p>Please be aware that this page will not be shown if you turn off debug mode unless you replace src/Template/Pages/huis.ctp with your own version.</p>
                </div>
                <div class="mijmenu">
                    <ul>
        ...
        <?php endif; ?>
            ...
            <div class="row">
                <div class="columns large-6">
                    ...
                    <ul>
                        <li class="bullet cutlery">To change the content of this page, edit: src/Template/Pages/huis.ctp.</li>
